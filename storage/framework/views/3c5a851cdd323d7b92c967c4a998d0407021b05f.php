    ...
    <div id="appImage" class="tab-pane fade">
     ...
     <div id="appPushResult" class="tab-pane fade">
        <div class="container-fluid">
              ...
              <?php endif; ?></p>
              <div class="container-fluid">
                  <p><a href="<?php echo e(route('examinee_confirm', $applicant->id)); ?>" type="button" class="btn btn-default glyphicon glyphicon-check"></a> Push to Results</p> 
              </div>
            </div>
          </div>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Devs\coas\resources\views/admission/examinee/edit.blade.php ENDPATH**/ ?>