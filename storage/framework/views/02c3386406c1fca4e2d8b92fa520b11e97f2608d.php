            ...
            <div class="well well-sm" style="border:2px solid #efff04;">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <button class="btn btn-success pull-right" onclick="copyToClipboard('#p1')">Copy ID</button>
                 ...
                 <div class="timeline-panel">
                   <div class="timeline-heading">
                     <div class="timeline-title">
                       ...
                       <h6><i>Date: <?php echo e(date('m-d-Y H:i:s')); ?></i></h6>
                     </div>
                   </div>
                ...
                <div class="timeline-date">
                 ...
                 <div class="timeline-panel">
                   <div class="timeline-heading">
                     <div class="timeline-title">
                       <p>Confirmation</p>
                       <h5>Wait for confirmation in your pre-enrolment</h5>
                       <h6><i>Status: Waiting</i></h6>
                     </div>
                   </div>
                   <div class="timeline-body">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script><?php /**PATH C:\coas\resources\views/portal/admission_current.blade.php ENDPATH**/ ?>