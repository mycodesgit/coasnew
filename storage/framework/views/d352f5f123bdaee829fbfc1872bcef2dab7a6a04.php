  ...
  <div class="col-md-5 jumbotron">
    <form method="post" action="<?php echo e(URL::route('createUser')); ?>">
       ...
       <div class="col-md-6" <?php echo e(($errors->has('campus')) ? 'has-error' : ''); ?>>
        ...
        <input type="text" name="lastname" style="text-transform: uppercase;" class="form-control" value="<?php echo e(old('lastname')); ?>">
      ...
      <div class="col-md-6" <?php echo e(($errors->has('firstname')) ? 'has-error' : ''); ?>>
        ...
        <input type="text" name="firstname" style="text-transform: uppercase;" class="form-control" value="<?php echo e(old('firstname')); ?>">
      ...
      <div class="col-md-6">
        ...
        <input type="text" name="middlename" style="text-transform: uppercase;" class="form-control" value="<?php echo e(old('middlename')); ?>">
      </div>
...
<?php echo $__env->make('layouts.master_settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u841447435/domains/cpsucoas.com/public_html/resources/views/control/settings/index.blade.php ENDPATH**/ ?>