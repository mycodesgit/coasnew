       ...
       <thead>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td style="text-transform: uppercase;"><b><?php echo e($applicant->lname); ?>, <?php echo e($applicant->fname); ?> <?php if($applicant->mname == null): ?> <?php else: ?> <?php echo e(substr($applicant->mname,0,1)); ?>.<?php endif; ?>   <?php if($applicant->ext == 'N/A'): ?> <?php else: ?><?php echo e($applicant->ext); ?><?php endif; ?></b></td>
