...
<?php $__env->startSection('workspace'); ?>
    <ol class="breadcrumb">
        ...
        <li style="text-transform: uppercase;"><?php echo e($applicant->fname); ?> <?php if($applicant->mname == null): ?> <?php else: ?> <?php echo e(substr($applicant->mname,0,1)); ?>.<?php endif; ?> <?php echo e($applicant->lname); ?>  <?php if($applicant->ext == 'N/A'): ?> <?php else: ?><?php echo e($applicant->ext); ?><?php endif; ?></a></li>
    ...
    <form method="POST" action="<?php echo e(route('applicant_schedule_save', $applicant->id)); ?>" enctype="multipart/form-data">
      ...
      <div class="col-md-4">
        ...
        <select class="form-control" name="d_admission" style="text-transform: uppercase;">
          ...
          <option value="<?php echo e($date1->date); ?>" <?php if(old('d_admission') == "<?php echo e($date1->date); ?>"): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($date1->date); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </div>
      <div class="col-md-4">
        ...
        <select class="form-control" name="time" style="text-transform: uppercase;">
          ...
          <option value="<?php echo e($time1->time); ?>" <?php if(old('time') == "<?php echo e($time1->time); ?>"): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e(\Carbon\Carbon::createFromFormat('H:i:s',$time1->time)->format('h:i A')); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </div>
      <div class="col-md-4">
        ...
        <select class="form-control" name="venue" style="text-transform: uppercase;">
          ...
          <option value="<?php echo e($venue1->venue); ?>" <?php if(old('venue') == "<?php echo e($venue1->venue); ?>"): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($venue1->venue); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </div>
      <div class="container-fluid">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u841447435/domains/cpsucoas.com/public_html/resources/views/admission/applicant/edit.blade.php ENDPATH**/ ?>