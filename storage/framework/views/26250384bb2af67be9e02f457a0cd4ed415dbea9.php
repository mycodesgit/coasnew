                ...
                <div class="row">
                  <div class="col-lg-offset-2 col-md-offset-1 col-sm-offset-1 col-xs-offset-1 col-lg-8 col-sm-10 col-xs-10">
                    <div class="alert alert-success" id="notifDiv"></div>
                      <a href="https://cpsucoas.com/portal/apply" type="button" class="btn btn-warning btn-block" style="border-radius: 0"> <h5 class="mb-1">Apply Admission</h5></a>
...
<?php /**PATH C:\xampp\htdocs\resources\views/portal/index.blade.php ENDPATH**/ ?>