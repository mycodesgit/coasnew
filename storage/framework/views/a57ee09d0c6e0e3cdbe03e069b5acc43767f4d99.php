    ...
    <div class="container-fluid" style="margin-top: 65px;">
        <div class="sidebar-menu col-md-2">
            ...
            <?php if(Auth::user()->isAdmin == 0): ?>
                <ul class="list-group">
                    <a href="<?php echo e(route('applicant-add')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='applicant-add'?'active':''); ?>">Add Applicants
                    </a>

                    <a href="<?php echo e(route('applicant-list')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='applicant-list'?'active':''); ?>">Applicants
                    </a>

                    <a href="<?php echo e(route('examinee-list')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='examinee-list'?'active':''); ?>">List of Examinees
                    </a>

                    <a href="<?php echo e(route('result-list')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='result-list'?'active':''); ?>">Examination Results
                    </a>

                    <a href="<?php echo e(route('examinee-confirm')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='examinee-confirm'?'active':''); ?>">Confirmed Applicants
                    </a>  

                    <a href="<?php echo e(route('applicant-accepted')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='applicant-accepted'?'active':''); ?>">Accepted Applicants
                    </a>

                    <a href="<?php echo e(route('slots')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='slots'?'active':''); ?>">Availability/Slots
                    </a>

                    <a href="<?php echo e(route('configure_admission')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='configure_admission'?'active':''); ?>">Configure Admission
                    </a>
                </ul>
                <div class="page-header">
                    Reporting
                ...
                <ul class="list-group">
                    <a href="<?php echo e(route('applicant_printing')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='applicant_printing'?'active':''); ?>">Applicants</a>
                    <a href="<?php echo e(route('schedules_printing')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='schedules_printing'?'active':''); ?>">Admission Schedules</a>
                    <a href="<?php echo e(route('examination_printing')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='examination_printing'?'active':''); ?>">Examination Results</a>
                    <a href="<?php echo e(route('qualified_printing')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='qualified_printing'?'active':''); ?>">List of Qualified Applicants</a>
                    <a href="<?php echo e(route('confirm_printing')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='confirm_printing'?'active':''); ?>">Confirmed Applicants</a> 
                    <a href="<?php echo e(route('accepted_printing')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='accepted_printing'?'active':''); ?>">List of Accepted Applicants</a>
                </ul>

            <?php elseif(Auth::user()->isAdmin == 1 || Auth::user()->isAdmin == 2): ?>
                <ul class="list-group">
                    <a href="<?php echo e(route('applicant-add')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='applicant-add'?'active':''); ?>">Add Applicants</a>
                    <a href="<?php echo e(route('applicant-list')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='applicant-list'?'active':''); ?>">Applicants</a>  
                    <a href="<?php echo e(route('examinee-list')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='examinee-list'?'active':''); ?>">List of Examinees</a>
                    <a href="<?php echo e(route('result-list')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='result-list'?'active':''); ?>">Examination Results</a>
                    <a href="<?php echo e(route('slots')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='slots'?'active':''); ?>">Availability/Slots</a>
                    <a href="<?php echo e(route('configure_admission')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='configure_admission'?'active':''); ?>">Configure Admission</a>
                </ul>
                <div class="page-header">
                    Reporting
                </div>
            ...
            <?php elseif(Auth::user()->isAdmin == 5 || Auth::user()->isAdmin == 6 || Auth::user()->isAdmin == 7): ?>
                <ul class="list-group">
                    <a href="<?php echo e(route('result-list')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='result-list'?'active':''); ?>">Examination Results</a>
                    <a href="<?php echo e(route('examinee-confirm')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='examinee-confirm'?'active':''); ?>">Confirmed Applicants</a>  
                    <a href="<?php echo e(route('applicant-accepted')); ?>" class="list-group-item <?php echo e($current_sidebar_route=='applicant-accepted'?'active':''); ?>">Accepted Applicants</a>
                </ul>
            <?php endif; ?>
                <div class="page-header">
                  CPSU - COAS V.1.0
...
<?php /**PATH C:\xampp\htdocs\coasnew\resources\views/layouts/master_admission.blade.php ENDPATH**/ ?>