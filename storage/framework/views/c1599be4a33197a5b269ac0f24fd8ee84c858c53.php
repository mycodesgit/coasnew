...
<body>
	<div class="container">
	    ...
	    <div class="container-info">
	    	...
	    	<div class="name-p-c"><b><?php echo e($applicant->fname); ?> <?php if($applicant->mname == null): ?> <?php else: ?> <?php echo e(substr($applicant->mname,0,1)); ?>.<?php endif; ?> <?php echo e($applicant->lname); ?>  <?php if($applicant->ext == 'N/A'): ?> <?php else: ?><?php echo e($applicant->ext); ?><?php endif; ?></b></div></div>
	    	<div class="name">
	    	...
	    	<div class="name-p-c-sex"><?php echo e($applicant->gender); ?></div>
	   	 	...
	   	 	<div class="name-p-c-schl" style="text-transform: uppercase;"><?php echo e($applicant->lstsch_attended); ?></div>
	   	 	<div class="name-p-sex">Senior High School Track/Strand:</div>
	   	 	<div class="name-p-c-schltrack" style="text-transform: uppercase;font-size:12px;"><?php if($applicant->strand == 'BAM'): ?> Business, Accountancy, Management (ABM) <?php elseif($applicant->strand == 'HUMSS'): ?> Humanities, Education, Social Sciences (HUMSS) <?php elseif($applicant->strand == 'GAS'): ?> General, Academic Strand (GAS) <?php elseif($applicant->strand == 'HESS'): ?> Humanities, Education, Social Sciences (HESS) <?php elseif($applicant->strand == 'STEM'): ?> Science, Technology, Engineering, Mathematics (STEM) <?php elseif($applicant->strand == 'TVL-CHF'): ?> TVL - Cookery, Home Economics, & FBS (TVL-CHF) <?php elseif($applicant->strand == 'TVL-CIV'): ?> TVL - CSS, ICT, & VGD (TVL-CIV) <?php elseif($applicant->strand == 'TVL-AFA'): ?> TVL - Agricultural & Fisheries Arts (TVL-AFA) <?php elseif($applicant->strand == 'TVL-EIM'): ?> TVL - Electrical Installation & Maintenance (TVL-EIM) <?php elseif($applicant->strand == 'TVL-SMAW'): ?> TVL - Shielded Metal Arc Welding (TVL-SMAW) <?php elseif($applicant->strand == 'OLD'): ?> Old Curriculum <?php endif; ?> </div>
	   	 	<p>For TRANSFEREE</p>
	   	 	<div class="name-p-sex">College/University last attended:</div>
	   	 	<div class="name-p-c-sucschl" style="text-transform: uppercase;"><?php echo e($applicant->suc_lst_attended); ?></div>
	   	 	<div class="name-p-sex">Course & Year:</div>
	   	 	<div class="name-p-c-course" style="text-transform: uppercase;"><?php echo e($applicant->course); ?></div>
	    	...
	    	<div class="name-p-c-d_test"><?php echo e($applicant->d_admission); ?></div>
	   	 	...
	   	 	<div class="name-p-c-time"><?php if($applicant->time == NULL): ?> <?php else: ?> <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s',$applicant->time)->format('h:i A')); ?><?php endif; ?></div>
	    	...
	    	<div class="name-p-c-d_test"><?php echo e($applicant->d_admission); ?></div>
	   	 	...
	   	 	<div class="name-p-c-time"><?php if($applicant->time == NULL): ?> <?php else: ?> <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s',$applicant->time)->format('h:i A')); ?><?php endif; ?></div>
	   	 	<div class="name-p-bday">Venue:</div>
	   	 	<div class="name-p-c-venue" tyle="text-transform: uppercase;"><?php echo e($applicant->venue); ?></div>
	   	 	<div class="name-p-c-guidance">SUNE S. QUINTAB</div>
	   	 	<p style="margin-left: 130px;margin-top: 5px;font-style: italic;">Guidance Counselor III/Coordinator, Admission Services</p>
...
</html><?php /**PATH /home/u841447435/domains/cpsucoas.com/public_html/resources/views/admission/applicant/print.blade.php ENDPATH**/ ?>