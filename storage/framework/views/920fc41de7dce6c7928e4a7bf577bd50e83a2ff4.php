    ...
    <table id="applicant-reports" class="display nowrap" style="width:100%">
      ...
      <tbody>
          ...
          <tr>
            ...
            <td><?php if($applicant->interview->remarks == 1): ?> Accepted for Enrollment <?php elseif($applicant->interview->remarks == 2): ?> Not Aceepted for Enrollment <?php else: ?> Waiting for Interview <?php endif; ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u841447435/domains/cpsucoas.com/public_html/resources/views/admission/reports/acceptedgen.blade.php ENDPATH**/ ?>