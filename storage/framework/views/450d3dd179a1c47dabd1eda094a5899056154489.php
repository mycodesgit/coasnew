  ...
  <body>
    ...
    <form method="post" action="post_admission_apply" enctype="multipart/form-data">
      ...
      <div class="container-fluid">
        ...
        <button type="submit" class="btn btn-warning mx-auto" style="border-radius: 0;margin-top: 50px;">Send</button>
   		 </div>
        </div>
  		</form>
      </div>
...
<?php /**PATH C:\coas\resources\views/portal/apply.blade.php ENDPATH**/ ?>