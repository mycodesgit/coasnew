...
<?php $__env->startSection('workspace'); ?>
  ...
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#schedexam" style="color:#008000;">Schedule Exam Date</a></li>
    <li><a data-toggle="tab" href="#printAppForm" style="color:#008000;">View/Print Data</a></li>
  ...
  <div class="tab-content">
    ...
    <div id="appPush" class="tab-pane fade">
      ...
      <div class="container-fluid">
          <div class="row">
              <p><a href="<?php echo e(route('applicant_confirm', $applicant->id)); ?>" type="button" class="btn btn-default glyphicon glyphicon-check"></a> Push to Examinee</p> 
          </div>
      </div>
      </div>
  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\coas\resources\views/admission/applicant/edit.blade.php ENDPATH**/ ?>