       ...
       <thead>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td><small><span><?php if($applicant->interview->remarks == 1): ?> Accepted for Enrolment <?php else: ?> Not accepted for enrolment <?php endif; ?></span></small></td>
                  <td><?php echo e($applicant->interview->course); ?></td>
                  <td style="text-align:center;">
                    <a data-toggle="tooltip" data-placement="bottom" title="Process Applicant"><i id="<?php echo e($applicant->id); ?>" data-toggle="modal" data-target="#info_app" class="btn btn-green info_applicant glyphicon glyphicon-tasks"></i></a>
                  </td>
                </tr> 
                <?php else: ?>
                <?php endif; ?>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            <?php if(Auth::user()->isAdmin == 5 || Auth::user()->isAdmin == 6 || Auth::user()->isAdmin == 7): ?>
...
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u841447435/domains/cpsucoas.com/public_html/resources/views/admission/conapp/search_confirm.blade.php ENDPATH**/ ?>