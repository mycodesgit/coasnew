...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        <iframe src="<?php echo e(route('applicant_genPermit', $applicant->id)); ?>" width="100%" height="800"></iframe>
    </div>
  </div>
</div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u841447435/domains/cpsucoas.com/public_html/resources/views/admission/applicant/printPermit.blade.php ENDPATH**/ ?>