    ...
    <table id="applicant-reports" class="display nowrap" style="width:100%">
      ...
      <tbody>
          ...
          <tr>
            ...
            <td>@if ($applicant->interview->remarks == 1) Accepted for Enrollment @elseif ($applicant->interview->remarks == 2) Not Aceepted for Enrollment @else Waiting for Interview @endif</td>
