	    ...
	    <div class="name">
	 	...
	 	<br>	
	      ...
	      <ul style="list-style-type: none;margin: 0;padding: 0;font-size: 10px;">
		      ...
		      <li><input type="checkbox" class="checkbox" value="BPED" {{ old('type', $examinee->interview->course) === 'BPED' ? 'checked' : '' }}> <span>Bachelor of Physical Education (BPED) major in School Physical Education major in:</span></li>
		      <li><input type="checkbox" class="checkbox" value="BSED" {{ old('type', $examinee->interview->course) === 'BSED' ? 'checked' : '' }}><span> Bachelor of Secondary Education</span></li>
