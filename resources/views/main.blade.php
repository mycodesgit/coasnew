                ...
                <div class="row">
                  <div class="col-lg-offset-2 col-md-offset-1 col-sm-offset-1 col-xs-offset-1 col-lg-8 col-sm-10 col-xs-10">
                    <div class="alert alert-success" id="notifDiv"></div>
                      <a href="{{ route('admission-portal') }}" type="button" class="btn btn-warning btn-block" style="border-radius: 0"> <h5 class="mb-1">Student</h5></a>
                      <a href="{{ route('home') }}" type="button" class="btn btn-warning btn-block" style="border-radius: 0"> <h5 class="mb-1">Employee</h5></a>
